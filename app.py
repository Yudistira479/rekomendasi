...
# PAGE 3 - GENRE (input manual judul novel)
    ...
    input_title = st.text_input("Masukkan judul novel:")
    ...
    if input_title:
        if input_title in novels['title'].values:
            ...
            st.warning("Judul novel tidak ditemukan di dataset. Silakan coba lagi.")
